...
export default function RevisarInfoScreen() {
    ...
    const checklistItems = [
        { item: "Estado optima de tren delantro", id: '' },
        { item: "Funcionamiento de amortiguadores", },
        { item: "Desgaste pastillas de Freno", },
        { item: "Estado de escobillas de limpiaparabrisas", },
    ];
